...
var COURSES = [
  ...
  {id:'prenatal',name:'孕产瑜伽',nameEn:'Prenatal Yoga',cat:'workshop',level:2,duration:60,
    ...
    equipment:['瑜伽垫','瑜伽砖×2','伸展带','毛毯×2','瑜伽抱枕','瑜伽球(可选)'],
    desc:'为孕中晚期的准妈妈提供安全、温和、有针对性的练习方案，缓解孕期不适、建立分娩准备力量。',
    objectives:['了解孕期瑜伽的安全原则与禁忌','掌握孕期安全体式库','学习骨盆底肌觉知与训练','掌握分娩呼吸法','了解产后恢复指引'],
    outline:[{title:'站立序列',text:'战士二式改良、侧角伸展改良、女神式'},{title:'坐姿序列',text:'侧卧束角式、坐角式、猫牛式'},{title:'分娩准备',text:'骨盆底肌觉知、深蹲呼吸法、哼鸣式呼吸'},{title:'孕期不适处方',text:'腰背痛、耻骨联合痛、水肿、失眠等对症体式'}],
    schedule:[['围坐分享','5min','当周身体感受交流'],['热身','10min','关节活动、骨盆摆动'],['站立序列','15min','安全站立体式'],['坐姿/侧卧','15min','开髋与呼吸'],['分娩准备','10min','呼吸法 + 骨盆底肌'],['放松','5min','侧卧 Savasana']],
    note:'绝对禁忌：仰卧（孕 20 周后）、俯卧、深扭转、深度后弯、倒置、屏气、跳跃。每位学员必须获得主治医生书面许可。围坐分享给予情感支持。'},
